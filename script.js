...
document.getElementById('convertBtn').addEventListener('click', async () => {
    ...
    feedbackDiv.innerHTML = `<p><strong class="has-text-white">${CURRENCY_ICONS[baseCurrency]} ${baseCurrency}</strong> priced at <strong class="has-text-primary">${baseValue.toFixed(2) || 1.00}</strong> converts to the following</p>`;
